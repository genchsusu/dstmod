...
local builds =
{
    normal = {
        ...
        normal_loot = {"log", "log", "log", "log", "log", "log", "log", "log", "log", "log", "pinecone"},
        short_loot = {"log", "log", "log", "log", "log", "log", "log", "log", "log", "log"},
        tall_loot = {"log", "log", "log", "log", "log", "log", "log", "log", "log", "log", "pinecone", "pinecone"},
        drop_pinecones=true,
        leif="leif",
    ...
    sparse = {
        ...
        grow_times=TUNING.EVERGREEN_GROW_TIME,
        normal_loot = {"log", "log", "log", "log", "log", "log", "log", "log", "log", "log"},
        short_loot = {"log", "log", "log", "log", "log", "log", "log", "log", "log", "log"},
        tall_loot = {"log", "log", "log", "log", "log", "log", "log", "log", "log", "log"},
