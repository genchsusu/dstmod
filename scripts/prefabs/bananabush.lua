...
local BANANABUSH_GROWTH_STAGES = {
    {
        ...
        time = function(inst) return 1 end, -- Gin
        fn = set_empty,
        growfn = grow_empty,
    },
    {
...
local function OnPicked(inst, picker)
    inst.components.pickable.cycles_left = 5 -- Gin (was null)
...
local function fn()
    ...
    inst.components.pickable.quickpick = true -- Gin (was null)
    ...
    inst.components.growable:SetStage(1)
    inst.components.growable.loopstages = true -- Gin (was false)
    ...
    -- MakeNoGrowInWinter(inst) -- Gin Always grow in winter
