...
-- Gin
PLANT_DEFS.randomseed.grow_time			= MakeGrowTimes(0, TUNING.SEG_TIME, 0, 0)

PLANT_DEFS.carrot.grow_time				= MakeGrowTimes(0, TUNING.SEG_TIME, 0, 0)
PLANT_DEFS.corn.grow_time				= MakeGrowTimes(0, TUNING.SEG_TIME, 0, 0)
PLANT_DEFS.potato.grow_time				= MakeGrowTimes(0, TUNING.SEG_TIME, 0, 0)
PLANT_DEFS.tomato.grow_time				= MakeGrowTimes(0, TUNING.SEG_TIME, 0, 0)
--
PLANT_DEFS.asparagus.grow_time			= MakeGrowTimes(0, TUNING.SEG_TIME, 0, 0)
PLANT_DEFS.eggplant.grow_time			= MakeGrowTimes(0, TUNING.SEG_TIME, 0, 0)
PLANT_DEFS.pumpkin.grow_time			= MakeGrowTimes(0, TUNING.SEG_TIME, 0, 0)
PLANT_DEFS.watermelon.grow_time			= MakeGrowTimes(0, TUNING.SEG_TIME, 0, 0)
--
PLANT_DEFS.dragonfruit.grow_time		= MakeGrowTimes(0, TUNING.SEG_TIME, 0, 0)
PLANT_DEFS.durian.grow_time				= MakeGrowTimes(0, TUNING.SEG_TIME, 0, 0)
PLANT_DEFS.garlic.grow_time				= MakeGrowTimes(0, TUNING.SEG_TIME, 0, 0)
PLANT_DEFS.onion.grow_time				= MakeGrowTimes(0, TUNING.SEG_TIME, 0, 0)
PLANT_DEFS.pepper.grow_time				= MakeGrowTimes(0, TUNING.SEG_TIME, 0, 0)
PLANT_DEFS.pomegranate.grow_time		= MakeGrowTimes(0, TUNING.SEG_TIME, 0, 0)
-- Gin
...
-- Gin 全季节都可以种植
-- season preferences
PLANT_DEFS.randomseed.good_seasons		= {autumn = true,	winter = true,	spring = true,	summer = true}
--
PLANT_DEFS.carrot.good_seasons			= {autumn = true,	winter = true,	spring = true,	summer = true}
PLANT_DEFS.corn.good_seasons			= {autumn = true,	winter = true,	spring = true,	summer = true}
PLANT_DEFS.potato.good_seasons			= {autumn = true,	winter = true,	spring = true,	summer = true}
PLANT_DEFS.tomato.good_seasons			= {autumn = true,	winter = true,	spring = true,	summer = true}
--
PLANT_DEFS.asparagus.good_seasons		= {autumn = true,	winter = true,	spring = true,	summer = true}
PLANT_DEFS.eggplant.good_seasons		= {autumn = true,	winter = true,	spring = true,	summer = true}
PLANT_DEFS.pumpkin.good_seasons			= {autumn = true,	winter = true,	spring = true,	summer = true}
PLANT_DEFS.watermelon.good_seasons		= {autumn = true,	winter = true,	spring = true,	summer = true}
--
PLANT_DEFS.dragonfruit.good_seasons		= {autumn = true,	winter = true,	spring = true,	summer = true}
PLANT_DEFS.durian.good_seasons			= {autumn = true,	winter = true,	spring = true,	summer = true}
PLANT_DEFS.garlic.good_seasons			= {autumn = true,	winter = true,	spring = true,	summer = true}
PLANT_DEFS.onion.good_seasons			= {autumn = true,	winter = true,	spring = true,	summer = true}
PLANT_DEFS.pepper.good_seasons			= {autumn = true,	winter = true,	spring = true,	summer = true}
PLANT_DEFS.pomegranate.good_seasons		= {autumn = true,	winter = true,	spring = true,	summer = true}
