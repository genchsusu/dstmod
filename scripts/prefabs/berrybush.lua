...
local function ontransplantfn(inst)
    inst.AnimState:PlayAnimation("dead")
    setberries(inst, nil)
    -- inst.components.pickable:MakeBarren() -- Gin
end
...
local function createbush(name, inspectname, berryname, master_postinit)
    ...
    local function fn()
        ...
        inst.components.pickable.quickpick = true -- Gin 快速采集
        ...
        -- MakeNoGrowInWinter(inst) -- Gin 冬天继续生长
...
local function normal_postinit(inst)
    inst.components.pickable:SetUp("berries", TUNING.BERRY_REGROW_TIME, 10) -- Gin 1 -> 10
...
local function juicy_postinit(inst)
    inst.components.pickable:SetUp("berries_juicy", TUNING.BERRY_JUICY_REGROW_TIME, 30) -- Gin 3 -> 30
